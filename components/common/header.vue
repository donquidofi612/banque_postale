...
<!--                    &lt;!&ndash; Start::header-link|layout-setting &ndash;&gt;-->
<!--                    <a href="javascript:void(0);" class="header-link layout-setting">-->
<!--                        <span class="light-layout" @click="colorthemeFn('dark')">-->
<!--                            &lt;!&ndash; Start::header-link-icon &ndash;&gt;-->
<!--                        <i class="bx bx-moon header-link-icon"></i>-->
<!--                            &lt;!&ndash; End::header-link-icon &ndash;&gt;-->
<!--                        </span>-->
...
<!--                        </span>-->
<!--                    </a>-->
<!--                    &lt;!&ndash; End::header-link|layout-setting &ndash;&gt;-->
<!--                </div>-->
                <!-- End::header-element -->
...
<!--                </div>-->
                ...
                <v-menu class="header-element" transition="slide-y-transition">
                    ...
                    <v-list class="main-header-dropdown pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end" aria-labelledby="mainHeaderProfile">
                        <v-list-item><NuxtLink to="#" class="dropdown-item d-flex"><i class="ti ti-user-circle fs-18 me-2 op-7"></i>Profile</NuxtLink></v-list-item>
...
<!--                        <v-list-item><a class="dropdown-item d-flex border-block-end" href="javascript:void(0);"><i class="ti ti-wallet fs-18 me-2 op-7"></i>Bal: $7,12,950</a></v-list-item>-->
                        <v-list-item><NuxtLink to="#" class="dropdown-item d-flex"><i class="ti ti-headset fs-18 me-2 op-7"></i>Support</NuxtLink></v-list-item>
